...
<head>
    <title>Talent Store | <?php echo $title; ?></title>
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url('assets/') ?>ico/favicon-16x16.png"/>
    ...
    <link href="<?php echo base_url('assets/') ?>css/header/header1.css" rel="stylesheet">
    <link id="color_scheme" href="<?php echo base_url('assets/') ?>css/theme.css" rel="stylesheet"> 
    <link href="<?php echo base_url('assets/') ?>css/responsive.css" rel="stylesheet">
    <link href='<?php echo base_url('assets/') ?>https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700' rel='stylesheet' type='text/css'>     
    <style type="text/css">
