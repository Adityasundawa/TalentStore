    ...
    <footer class="footer-container typefooter-1">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12 col-infos">
                        <div class="infos-footer">
                            <a href="#"><img src="<?= base_url('assets/')?>image/catalog/logo-footer.png" alt="image"></a>
                            <ul class="menu">
                                <li class="adres">
            ...
            <div class="row">
                        <div class="footer-b">
                            <div class="bottom-cont">
                                <a href="#"><img src="<?= base_url('assets/')?>image/catalog/demo/payment/pay1.jpg" alt="image"></a>
        ...
        <div class="footer-bottom">
            <div class="container">
                ...
                <img src="<?= base_url('assets/')?>image/catalog/demo/payment/payment.png" alt="imgpayment">
                </div>
            </div>
...
<script type="text/javascript" src="<?= base_url('assets/')?>js/slick-slider/slick.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/themejs/libs.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/unveil/jquery.unveil.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/countdown/jquery.countdown.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/dcjqaccordion/jquery.dcjqaccordion.2.8.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/datetimepicker/moment.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/jquery-ui/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/modernizr/modernizr-2.6.2.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/minicolors/jquery.miniColors.min.js"></script>

<!-- Theme files
============================================ -->

<script type="text/javascript" src="<?= base_url('assets/')?>js/themejs/application.js"></script>

<script type="text/javascript" src="<?= base_url('assets/')?>js/themejs/homepage.js"></script>

<script type="text/javascript" src="<?= base_url('assets/')?>js/themejs/toppanel.js"></script>
<script type="text/javascript" src="<?= base_url('assets/')?>js/themejs/so_megamenu.js"></script>
...
<!-- Mirrored from demo.smartaddons.com/templates/html/supermarket/index.html?route=product/special by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jul 2018 19:18:54 GMT -->
</html>